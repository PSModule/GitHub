function Connect-GitHubAccount {
    ...
    begin {
        ...
        if (-not (Get-Variable -Name $script:GitHub.Config.HttpResponseHeadersVariable  -Scope Global -ErrorAction SilentlyContinue)) {
            Set-Variable -Name $script:GitHub.Config.HttpResponseHeadersVariable -Value ([System.Collections.Generic.List[object]]::new()) -Scope Global
        }
    }
